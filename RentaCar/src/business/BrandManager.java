...
public class BrandManager {
    ...
    public boolean save(Brand brand) {
        ...
        if (brand.getId() != 0) {
            Helper.showMsg("Error: Brand ID should be null for a new brand.");
        }
    ...
    public boolean update(Brand brand) {
        ...
        if (this.getById(brand.getId()) == null) {
            Helper.showMsg("Error: Brand not found for update.");
        }
    ...
    public boolean delete(int id) {
        ...
        if (this.getById(id) == null) {
            Helper.showMsg(id + " ID: Brand not found for deletion.");
            return false;
        }
