...
public class CarManager {
    ...
    public boolean save(Car car) {
        ...
        if (this.getById(car.getId()) != null) {
            Helper.showMsg("Error: Car with ID " + car.getId() + " already exists.");
            return false;
        }
    ...
    public boolean update(Car car) {
        ...
        if (this.getById(car.getId()) == null) {
            Helper.showMsg("Error: Car with ID " + car.getId() + " not found for update.");
            return false;
        }
    ...
    public boolean delete(int id) {
        ...
        if (this.getById(id) == null) {
            Helper.showMsg("Error: Car with ID " + id + " not found for deletion.");
            return false;
        }
