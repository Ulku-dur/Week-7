...
public class ModelView extends Layout {
    ...
    private Model model;
    private ModelManager modelManager; // kayıt işlemi için gerekli
    ...
    public ModelView(Model model) {
        ...
        for (Brand brand : this.brandManager.findAll()) { // db den veriler alındı combo box a add lendi
            this.cmb_brand.addItem(new ComboItem(brand.getId(), brand.getName())); //combo da id değerini görmedik çünkü combo item setValue nin return değeri string
        }
