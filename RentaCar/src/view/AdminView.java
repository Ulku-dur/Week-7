...
public class AdminView extends Layout {
    ...
    private JPopupMenu model_menu; // kendimiz tanımlıyoruz
    ...
    public AdminView(User user) {
        ...
        loadBrandComponent();
        // Model Tab Menu
        loadModelTable(null); // program açılır açılmaz veriler db den çekildi
        loadModelComponent();
        loadModelFilter();
        // Car Tab Menu
        loadCarTable();
    ...
    private void loadModelComponent() {
        ...
        this.tbl_model.setComponentPopupMenu(model_menu); // ilgili satıra gelince menü açıyor crud işlemleri için
    ...
    public void loadModelTable(ArrayList<Object[]> modelList) {
        ...
        // kendimiz default table oluşturduk
        // tek boyutlu array oluşturduk. tablo sütun isimlerini tutmak için
        // bunları önce defaultable a ardından da j table setleyerek görünüm elde ederiz.
        // db ye bağlanıp ilgili tablodaki tüm satırları arraylist e çekmek
        // defaulttable a setlemek için object[] e dönüşüm **getForTable
        // defaulttable a setlenecek
        this.col_model = new Object[]{"Model ID", "Marka", "Model Adı", "Tip", "Yıl", "Yakıt Türü", "Vites"};
        if (modelList == null) {
            // verileri kullanıcıya gösterebilmek için tek boyutlu diziye dönüştür
            modelList = this.modelManager.getForTable(this.col_model.length, this.modelManager.findAll());
        }
        createTable(tmdl_model, this.tbl_model, col_model, modelList); // kullanıcıya göstermek için oluşturulan tablo
    }
